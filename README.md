...
# Author 
![Screenshot](https://github.com/Saikohackerteamrm/GALLERY_EYE/blob/main/20250805_155858.jpg)
...
____________________
    ...
    $ git clone https://github.com/Saikohackerteamrm/GALLERY_EYE
    $ cd  GALLERY_EYE
    $ python Mithila.py
...
_______________________________________
    ...
    apt update -y && apt upgrade -y && pkg install git -y && pkg install python -y  && git clone https://github.com/Saikohackerteamrm/GALLERY_EYE && cd GALLERY_EYE && python Mithila.py
 ### Hi there 👋
